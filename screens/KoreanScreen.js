...
const foodItems = [
    {
      ...
      minOrder: '10,000원',
      images: [
        require('../images/koreanfood/korean_menu1.png'), 
        require('../images/koreanfood/korean_menu2.png'),
        require('../images/koreanfood/korean_menu3.png'),
      ],
    },
    {
      id: 2,
      ...
      minOrder: '13,000원',
      images: [
        require('../images/koreanfood/korean_menu4.png'),
        require('../images/koreanfood/korean_menu5.png'),
        require('../images/koreanfood/korean_menu6.png'),
      ],
    },
    {
      id: 3,
      ...
      minOrder: '8,000원',
      images: [
        require('../images/koreanfood/korean_menu7.png'),
        require('../images/koreanfood/korean_menu8.png'),
        require('../images/koreanfood/korean_menu9.png'),
      ],
    }
  ];
    ...
    return(
      <View style={styles.listConatiner}>
        <View style={styles.listHeader}>
          ...
          <Text style={styles.chTitle}>한식</Text>
