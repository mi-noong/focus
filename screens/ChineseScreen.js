...
const foodItems = [
    {
      ...
      minOrder: '13,000원',
      images: [
        require('../images/chinesefood/chinese_menu1.png'), 
        require('../images/chinesefood/chinese_menu2.png'),
        require('../images/chinesefood/chinese_menu3.png'),
      ],
    },
    {
      id: 2,
      ...
      minOrder: '14,000원',
      images: [
        require('../images/chinesefood/chinese_menu4.png'),
        require('../images/chinesefood/chinese_menu5.png'),
        require('../images/chinesefood/chinese_menu6.png'),
      ],
    },
    {
      id: 3,
      ...
      minOrder: '10,000원',
      images: [
        require('../images/chinesefood/chinese_menu7.png'),
        require('../images/chinesefood/chinese_menu8.png'),
        require('../images/chinesefood/chinese_menu9.png'),
      ],
    }
  ];
  
  const ChineseScreen = ({navigation}) => {
    ...
    return(
      <View style={styles.listConatiner}>
        <View style={styles.listHeader}>
          ...
          <Text style={styles.chTitle}>중식</Text>
