...
const foodItems = [
    {
      ...
      minOrder: '11,000원',
      images: [
        require('../images/japanesefood/japanese_menu1.png'), 
        require('../images/japanesefood/japanese_menu2.png'), 
        require('../images/japanesefood/japanese_menu3.png'), 
      ],
    },
    {
      id: 2,
      ...
      minOrder: '14,500원',
      images: [
        require('../images/japanesefood/japanese_menu4.png'),
        require('../images/japanesefood/japanese_menu5.png'), 
        require('../images/japanesefood/japanese_menu6.png'), 
      ],
    },
    {
      id: 3,
      ...
      minOrder: '6,000원',
      images: [
        require('../images/japanesefood/japanese_menu7.png'), 
        require('../images/japanesefood/japanese_menu8.png'), 
        require('../images/japanesefood/japanese_menu9.png'), 
      ],
    }
  ];
  
  const JapaneseScreen = ({navigation}) => {
    ...
    return(
      <View style={styles.listConatiner}>
        <View style={styles.listHeader}>
          ...
          <Text style={styles.chTitle}>일식</Text>
