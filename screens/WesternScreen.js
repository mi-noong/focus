...
const foodItems = [
    {
      ...
      minOrder: '8,900원',
      images: [
        require('../images/westernfood/western_menu1.png'), 
        require('../images/westernfood/western_menu2.png'),
        require('../images/westernfood/western_menu3.png'),
      ],
    },
    {
      id: 2,
      ...
      minOrder: '14,500원',
      images: [
        require('../images/westernfood/western_menu4.png'), 
        require('../images/westernfood/western_menu5.png'),
        require('../images/westernfood/western_menu6.png'),
      ],
    },
    {
      id: 3,
      ...
      minOrder: '6,000원',
      images: [
        require('../images/westernfood/western_menu7.png'), 
        require('../images/westernfood/western_menu8.png'),
        require('../images/westernfood/western_menu9.png'),
      ],
    }
  ];
  
  const WesternScreen = ({navigation}) => {
    ...
    return(
      <View style={styles.listConatiner}>
        <View style={styles.listHeader}>
          ...
          <Text style={styles.chTitle}>양식</Text>
